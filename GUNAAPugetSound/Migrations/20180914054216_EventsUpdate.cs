        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbumDesc = table.Column<string>(maxLength: 200, nullable: false),
                    AlbumName = table.Column<string>(maxLength: 160, nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime", nullable: false),
                    CreatedBy = table.Column<string>(maxLength: 160, nullable: false, defaultValueSql: "('')"),
                    EditTime = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastEditBy = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraduationYear = table.Column<int>(nullable: false, defaultValueSql: "((0))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "('1900-01-01T00:00:00.000')"),
