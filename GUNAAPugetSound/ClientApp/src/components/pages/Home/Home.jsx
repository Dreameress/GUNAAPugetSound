...
export class Home extends Component {
  ...
  render() {
    return (
      <div>
        <ContainerHeader headerText="Welcome" headerMessage="Welcome to the Home Site of the Puget Sound Chapter Of the Grambling University National Alumni Association" />
